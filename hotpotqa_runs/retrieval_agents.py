...
class ReflexionStrategy(Enum):
    ...
    RETRIEVED_TRAJECTORY_REFLEXION: Retrieve top-k similar past trajectories using error-first
                                    filtering + cosine similarity reranking.
    """
    NONE = 'base'
...
class TrajectoryStore:
    ...
    Retrieval uses error-first filtering with fallback:
        ...
        Step 2 — Rank filtered failures by pure cosine similarity
...
# ---------------------------------------------------------------------------
# ReactReflectAgent (unchanged except TrajectoryStore init — no lambdas)
# ---------------------------------------------------------------------------
